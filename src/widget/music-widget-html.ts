...
export const MUSIC_WIDGET_URI = "ui://music-mcp/player-v9.html";
...
const CSS = `
 ...
 [hidden] { display:none !important; }
  ...
  .player { background:transparent; padding:20px; width:100%; }
  ...
  .meta b { display:block; font-size:17px; font-weight:700;
            white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
  .meta .artist { font-size:14px; color:var(--text-2);
 ...
 :root[data-theme="dark"] {
  ...
  .meta b { line-height:1.5; } .artist { line-height:1.6; }
  .pg { display:block; appearance:none; -webkit-appearance:none; width:100%; height:22px;
    border:0; margin:0; border-radius:0; overflow:visible; background:transparent; }
  .pg::-webkit-slider-runnable-track { height:6px; border-radius:4px;
    background:linear-gradient(90deg,var(--accent-2),var(--accent)) 0/var(--progress,0%) 100% no-repeat,var(--bg-tint); }
  .pg::-moz-range-track { height:6px; border-radius:4px; background:var(--bg-tint); }
  .pg::-moz-range-progress { height:6px; background:linear-gradient(90deg,var(--accent-2),var(--accent)); }
  .pg::-webkit-slider-thumb { appearance:none; -webkit-appearance:none; width:12px; height:12px;
    border:2px solid var(--surface); border-radius:50%; background:var(--accent); margin-top:-3px; }
  .pg::-moz-range-thumb { width:10px; height:10px; border:2px solid var(--surface); border-radius:50%; background:var(--accent); }
  .pg:disabled { cursor:default; }
  .pg-lab { margin-top:0; color:var(--text-2); font-size:12px; }
  .ctrls { margin-top:12px; } .ctrls .big { width:48px; height:48px; }
  .lyric { font-size:14px; white-space:normal; line-height:1.6; color:var(--accent); }
  .status { margin-top:12px; font-size:14px; line-height:1.6; color:var(--text-2); }
  .queue { max-height:none; overflow:visible; }
  .qrow { width:100%; border:0; background:transparent; text-align:left; font:inherit; padding:10px 8px; }
  .qrow .qt { font-size:14px; } .qrow .qa { font-size:12px; }
  button:focus-visible,input:focus-visible { outline:2px solid var(--accent-2); outline-offset:3px; }
  @media(max-width:380px) { .player { padding:16px; } .cover { width:64px; height:64px; } .top { gap:12px; } }
`;
